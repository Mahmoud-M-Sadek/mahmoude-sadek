  ...
  return (
    <section id="services" className="py-20 bg-slate-50 dark:bg-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Security Section */}
        <div className="mb-20">
          <h3 className="text-2xl font-bold text-primary-600 mb-8 flex items-center gap-3">
             <div className="h-8 w-1 bg-primary-600 rounded-full"></div>
             {t.services.securityTitle}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {securityServices.map((service, index) => (
              <div key={index} className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-slate-100 dark:border-slate-700 group">
        ...
        {/* Software Section */}
        <div>
          <h3 className="text-2xl font-bold text-blue-500 mb-8 flex items-center gap-3">
